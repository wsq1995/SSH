...
<!-- 查询条件：马上查询 -->
<form id="conditionFormId" action="query.action" method="post">
...
<table width="100%" border="1">
    ...
    <s:iterator value="staffs" var="st">
        <tr class="tabtd1">
            <td align="center">${st.staffName}</td>
            <td align="center">${st.gender}</td>
            <td align="center">${st.onDutyDate}</td>
            <td align="center">${st.dep.depName}</td>
            <td align="center">${st.post.postName}</td>
            <td width="7%" align="center">
                <a href="middle.action?staffId=${st.staffId}">
